...
public class SeafoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catsea);
        ...
        backBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new
                        Intent(SeafoodActivity.this,HomeActivity.class);
                startActivity(i);
            }
        ...
        recyclerView = findViewById(R.id.sea_rec);
        ...
        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("item/seafood");
        ...
        productAdapter.setOnItemClickListener(new ProductAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Product product) {
                ...
                Intent intent = new Intent(SeafoodActivity.this, ItemActivity.class);
