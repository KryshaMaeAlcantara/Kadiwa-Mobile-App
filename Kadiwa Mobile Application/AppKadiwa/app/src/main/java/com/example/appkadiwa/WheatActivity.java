...
public class WheatActivity extends AppCompatActivity {
    ...
    private static final String TAG = "WheatActivity";
    private ImageView backBut;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_catwheat);
        ...
        backBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new
                        Intent(WheatActivity.this,HomeActivity.class);
                startActivity(i);
            }
        ...
        recyclerView = findViewById(R.id.wheaat_rec);
        ...
        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("item/wheat");
        ...
        productAdapter.setOnItemClickListener(new ProductAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Product product) {
                ...
                Intent intent = new Intent(WheatActivity.this, ItemActivity.class);
