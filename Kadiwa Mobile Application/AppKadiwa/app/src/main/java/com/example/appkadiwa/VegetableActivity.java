...
public class VegetableActivity extends AppCompatActivity {
    ...
    private static final String TAG = "VegetableActivity";
    private ImageView backBut;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_catveg);
        ...
        backBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new
                        Intent(VegetableActivity.this,HomeActivity.class);
                startActivity(i);
            }
        ...
        recyclerView = findViewById(R.id.veg_rec);
        ...
        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("item/vegetables");
        ...
        productAdapter.setOnItemClickListener(new ProductAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Product product) {
                ...
                Intent intent = new Intent(VegetableActivity.this, ItemActivity.class);
